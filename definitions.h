...
struct lista_matrices{
    GLfloat matriz[16];
    struct lista_matrices *pmptr;
};

typedef struct lista_matrices lista_matrices;
/****************************
...
struct object3d{
    ...
    lista_matrices *primera_matrizptr;  /*primera matriz en la pila*/
};

typedef struct object3d object3d;
struct camara{
    
    GLfloat matrizCamara[16];
    GLfloat matrizTransformaciones[16];
};
